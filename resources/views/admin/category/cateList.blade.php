    ...
    <div class="container-fluid px-4">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <tr>
              ...
              <td class="text-center">
                   ...
                   <a href="" class="btn btn-warning">
                    <form action="{{ route('admin.category.cateUpdateForm', $item->id) }}" method="GET">
                        <button type="submit">
                                  Edit
                       </button>
                        </form>
                 ...
                 <a href="" class="btn btn-danger">
                    <form action="{{ route('admin.category.cateDestroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
          ...
          <a href="{{ route('admin.category.viewCateAdd') }}">
