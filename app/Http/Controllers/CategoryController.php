...
class CategoryController extends Controller
{
    public function categoryList()
    {
        ...
        return view('admin.category.cateList', compact('categories'));
    }

    public function viewCateAdd()
    {
        $categories = Category::orderBy('name', 'asc')->get();
        return view('admin.category.viewCateAdd', compact('categories'));
    }
    public function cateAdd(Request $request)
    {
        ...
        return redirect()->route('admin.category.categoryList')->with('success', 'Thêm category thành công'); //Chuyển hướng người dùng đến route productList và kèm theo thông báo thành công.
    }
    //hien thi formUpdate
    public function cateUpdateForm($id)
    {
        ...
        return view('admin.category.cateUpdateForm', compact('categories', 'cate'));
    }
    //update data
    public function cateUpdate(Request $request)
    {
        ...
        return redirect()->route('admin.category.categoryList')->with('success', 'Cập nhật category thành công.');
    }
    public function cateDestroy($id)
    {
        ...
        $category->delete();
        return redirect()->route('admin.category.categoryList')->with('success', 'Category đã được xóa thành công.');
    }
}
